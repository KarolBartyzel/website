...
import { FaCode, FaPlay, FaRunning } from 'react-icons/fa';
  ...
  return (
    <div className="flex flex-col items-center w-full border-gray-500 px-4 gap-3">
        ...
        <div className="flex flex-row gap-2">
            <button aria-label="Code" title="Code" onClick={handleCodeClick} className="flex items-center gap-2 px-2 py-1 rounded-md border border-gray-300
            transition-all duration-200 hover:border-gray-400 hover:bg-gray-50 hover:scale-105">
                <FaCode className="w-4 h-4" />
            </button>
            <button aria-label="Demo" title="Demo" onClick={handleDemoClick} className="flex items-center gap-2 px-2 py-1 rounded-md border border-gray-300
            transition-all duration-200 hover:border-gray-400 hover:bg-gray-50 hover:scale-105">
